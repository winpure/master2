                ...
                if (!string.IsNullOrEmpty(textValue))
                {
                    ...
                    if (_settings.Any(s => !string.IsNullOrEmpty(s.RemoveCharacters)))
                    {
                        textValue = textValue.Replace(
                            _settings.First(s => !string.IsNullOrEmpty(s.RemoveCharacters)).RemoveCharacters, "");
                    }
                    ...
                    if (_settings.Any(s => !string.IsNullOrEmpty(s.RegexExpression)))
                    {
                        var regexExpression = _settings.First(s => !string.IsNullOrEmpty(s.RegexExpression));
                        textValue = Regex.Replace(textValue, regexExpression.RegexExpression,
                            regexExpression.RegexReplace);
                    }
                }
