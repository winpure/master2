...
public class WinPureCleanSettings
{
    public WinPureCleanSettings()
    {
        ...
        AddressAndGenderSplitSettings = new AddressAndGenderSplitSettings();
    }

    /// <summary>
    /// Split address and gender using loqate
    /// </summary>
    public AddressAndGenderSplitSettings AddressAndGenderSplitSettings { get; set; }
