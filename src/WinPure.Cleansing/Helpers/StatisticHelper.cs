...
internal static class StatisticHelper
{
    internal static ColumnStatistic CalculateStatisticForColumn(List<string> values, string columnName, Type columnType, DataField dataField, int totalCount, int order)
    {
        ...
        if (columnType == typeof(string))
        {
            ...
            columnStatistic.MixedCase = columnStatistic.MixedCase > columnStatistic.ProperCase
                ? columnStatistic.MixedCase - columnStatistic.ProperCase
                : 0;
        ...
        if (regexPattern != null)
        {
            ...
            columnStatistic.UnmatchPattern = notNullRows.Count - columnStatistic.MatchPattern;
        }
        else
        {
    ...
    private static DataTable GetStatisticTableSchema()
    {
        ...
        retTable.Columns.Add(new DataColumn("PatternName", typeof(string)));
