...
internal static class VerificationDictionaries
{
    ...
    internal static readonly Dictionary<string, string> VerificationStatus = new Dictionary<string, string>
    {
        {"V","Verified" },
    ...
    internal static readonly Dictionary<string, string> PostProcessed = new Dictionary<string, string>
    {
    ...
    internal static readonly Dictionary<string, string> PreProcessed = new Dictionary<string, string>
    {
    ...
    internal static readonly Dictionary<string, string> ParsingStatus = new Dictionary<string, string>
    {
        {"I", "Identified and Parsed"},
        {"U", "Unable to parse"},
    };

    internal static readonly Dictionary<string, string> Lexicon = new Dictionary<string, string>
    {
    ...
    internal static readonly Dictionary<string, string> Context = new Dictionary<string, string>
    {
    ...
    internal static readonly Dictionary<string, string> PostcodeStatus = new Dictionary<string, string>
    {
    ...
    #region UK Dictionary
    internal static Dictionary<string, int> InitiateCorrectionResult()
    {
    ...
    internal static readonly Dictionary<string, string> CorrectValues = new Dictionary<string, string> {
        { "10","A full postcode was supplied on the input address and this is the PAF® record which matches that postcode"},
        {"11","As for 0 above, but the given postcode had typographical errors (e.g. zero for alphabetic O and vice versa). These errors were corrected automatically, but the resultant PAF® address is placed in the Altered category so that the invalid postcode can be replaced."},
        {"12"," The input address had a valid full postcode, but this PAF® record relates to a different postcode"},
        {"13","The input address had a full postcode, but it was invalid, i.e. it did not exist"},
        {"14"," The input address had a part postcode, and this PAF® record includes the given part postcode"},
        {"15","The input address had a part postcode, but this PAF® record does not match it"},
        {"16","The input address had no postcode"},
        {"20","The given postcode was acceptable (possibly after correcting typographical errors, see above)"},
        {"21","No postcode was given, an acceptable one has been found "},
        {"22","Wrong, invalid or part postcode given, an acceptable one has been found "},
        {"23","Matching achieved to thoroughfare level, this is the only postcode for the thoroughfare "},
        {"24","Matching achieved to thoroughfare level, there are multiple postcodes for the thoroughfare, but this one is preferred. This may be because it was the given postcode, or because it contained the nearest premise number to the given one."},
        {"25","Matching achieved to thoroughfare level, there are multiple postcodes for this thoroughfare, this one is not preferred"},
        {"28","Matching has failed, this is the PAF® record for the given postcode "},
        {"29","Matching failed, this is a possible match for user consideration "},
        {"30","Acceptable match to thoroughfare, or no input details from county down to thoroughfare"},
        {"31","Input locality not on the PAF® record, or vice versa "},
        {"32","Locality mismatch between input and this PAF® record, but the address lines above and below locality are present and match perfectly"},
        {"33","Locality mismatch between input and this PAF® record, matching errors also in lines either side"},
        {"38","Match failed due to street descriptor mismatch "},
        {"39","Match failed at thoroughfare level, i.e. there is a serious mismatch in one or more of the lines between thoroughfare and county"},
        {"40","Acceptable match to premise level "},
        {"41","Premise not matched, premise is alphanumeric or numeric and this PAF® record contains premise numbers above and below the given value"},
        {"42","Premise not matched, premise is alphanumeric or numeric and this PAF® record contains premise numbers below the given value "},
        {"43","Premise not matched, premise is alphanumeric or numeric and this PAF® record contains premise numbers above the given value "},
        {"47","The input address contained no details at premise level "},
        {"48","Premise not checked, the match failed at thoroughfare level "},
        {"49","Match failed at premise level, either because of number mismatch or because a premise name could not be found "},
        {"50","Acceptable match to subbuilding or flat level "},
        {"51","Numeric or alphanumeric flat or subbuilding given, PAF® record contains values either side of the given value "},
        {"52","Numeric or alphanumeric flat or subbuilding given, PAF® record contains values below the given value "},
        {"53","Numeric or alphanumeric flat or subbuilding given, PAF® record contains values above the given value "},
        {"57","No input at flat or subbuilding level "},
        {"58","Match failed at premise level or higher - not checked "},
        {"59"," Match failed at flat/subbuilding level."} };
    #endregion
}