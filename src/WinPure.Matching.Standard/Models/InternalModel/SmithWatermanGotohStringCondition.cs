...
internal class SmithWatermanGotohStringCondition : StringCondition
{
    /// <summary>
    ...
    public SmithWatermanGotohStringCondition(string value, IFuzzyComparison comparison, MatchConditionBase condition, IDictionaryService dictionaryService) : base(value, condition, dictionaryService)
    {
