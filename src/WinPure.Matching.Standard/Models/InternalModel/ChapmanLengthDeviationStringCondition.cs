...
/// </summary>
internal class ChapmanLengthDeviationStringCondition : StringCondition
{
    /// <summary>
    ...
    public ChapmanLengthDeviationStringCondition(string value, IFuzzyComparison comparison, MatchConditionBase condition, IDictionaryService dictionaryService) : base(value, condition, dictionaryService)
    {
