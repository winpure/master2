...
internal class SqlSyntaxHighlightService : ISyntaxHighlightService
{
    ...
    public SqlSyntaxHighlightService(Document document)
    {
        ...
        string[] keywords = { "INSERT", "SELECT", "CREATE", "TABLE", "USE", "IDENTITY", "ON", "OFF", "NOT", "NULL", "WITH", "SET", "GO", "DECLARE", "EXECUTE", "NVARCHAR", "FROM", "INTO", "VALUES", "WHERE", "AND", "TOP", "LIMIT", "UNION", "AS", "IN", "ASC", "DESC", "ORDER","BY", "INNER", "JOIN", "LEFT", "HAVING" };
...
internal class SyntaxHighlightTokenComparer : IComparer<SyntaxHighlightToken>
{
